...
# can be deactivated by commenting out keystone/contrib/delegated_auth/core.py +380
VERIFIER=$(curl -X POST -H "X-Auth-Token: $ADMIN_TOKEN" http://$URL:5000/v3/OS-OAUTH10A/authorize/$REQUEST_TOKEN_KEY/$MEMBER_ID)
